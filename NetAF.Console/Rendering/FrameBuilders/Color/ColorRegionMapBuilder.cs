...
namespace NetAF.Console.Rendering.FrameBuilders.Color
{
    ...
    public sealed class ColorRegionMapBuilder : IRegionMapBuilder
    {
        ...
        /// <summary>
        /// Get the grid string builder.
        /// </summary>
        public GridStringBuilder GridStringBuilder { get; private set; }
        ...
        /// <summary>
        /// Initializes a new instance of the ColorRegionMapBuilder class.
        /// </summary>
        /// <param name="gridStringBuilder">The grid string builder.</param>
        public ColorRegionMapBuilder(GridStringBuilder gridStringBuilder)
        {
