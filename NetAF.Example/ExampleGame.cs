...
namespace NetAF.Example
{
    public class ExampleGame
    {
        ...
        public static GameCreator Create(GameConfiguration configuration)
        {
            ...
            return Game.Create(new("NetAF Demo", about, "By Ben Pollard 2011 - 2026."), about, AssetGenerator.Custom(overworldCreator, new Player().Instantiate), new GameEndConditions(DetermineIfGameHasCompleted, DetermineIfGameOver), configuration);
        }
    }
}
