...
namespace NetAF.Logic
{
    ...
    public sealed class Game : IRestoreFromObjectSerialization<GameSerialization>
    {
        ...
        private UpdateResult UpdateWhenNotStarted()
        {
            ...
            switch (Configuration.StartMode)
            {
                ...
                case StartModes.Scene:
                    ...
                    HandleReaction(Reaction.Silent);
        ...
        /// </summary>
        /// <returns>The update result.</returns>
        private UpdateResult UpdateWhenActive(string input)
        {
            // process the input
        ...
        /// </summary>
        /// <returns>The update result.</returns>
        private UpdateResult UpdateWhenEndConditionMet()
        {
        ...
        /// </summary>
        /// <returns>The update result.</returns>
        private UpdateResult UpdateWhenFinishing()
        {
            // finished execution
        ...
        internal UpdateResult Update(string input = "")
        {
            return State switch
            {
                GameState.NotStarted => UpdateWhenNotStarted(),
                GameState.Active => UpdateWhenActive(input),
                GameState.EndConditionMet => UpdateWhenEndConditionMet(),
                GameState.Finishing => UpdateWhenFinishing(),
