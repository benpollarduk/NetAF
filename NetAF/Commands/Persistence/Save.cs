...
namespace NetAF.Commands.Persistence
{
    ...
    public sealed class Save : CustomCommand
    {
        ...
        /// </summary>
        public Save() : base(new CommandHelp("Save", "Save the game state to a file.", instructions: "When saving the path should be specified as an absolute path."), true, true, SaveGameToFile) { }
