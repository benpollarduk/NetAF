...
{
    /// <summary>
    /// Represents the PanWest command.
    /// </summary>
    public class PanWest : ICommand
    {
        ...
        /// </summary>
        public static CommandHelp CommandHelp { get; } = new("West", "Pan west", "W");
        ...
        public Reaction Invoke(Logic.Game game)
        {
            ...
            if (game.Mode is RegionMapMode regionMapMode)
            {
                ...
                if (RegionMapMode.CanPanToPosition(game.Overworld.CurrentRegion, newPosition))
                {
                    ...
                    return new(ReactionResult.Silent, "Panned left.");
                }
                else
                {
