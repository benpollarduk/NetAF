...
{
    /// <summary>
    /// Represents the PanNorth command.
    /// </summary>
    public class PanNorth : ICommand
    {
        ...
        /// </summary>
        public static CommandHelp CommandHelp { get; } = new("North", "Pan north", "N");
        ...
        public Reaction Invoke(Logic.Game game)
        {
            ...
            if (game.Mode is RegionMapMode regionMapMode)
            {
                ...
                if (RegionMapMode.CanPanToPosition(game.Overworld.CurrentRegion, newPosition))
                {
                    ...
                    return new(ReactionResult.Silent, "Panned up.");
                }
                else
                {
