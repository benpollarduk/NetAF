...
{
    /// <summary>
    /// Represents the PanSouth command.
    /// </summary>
    public class PanSouth : ICommand
    {
        ...
        /// </summary>
        public static CommandHelp CommandHelp { get; } = new("South", "Pan south", "S");
        ...
        public Reaction Invoke(Logic.Game game)
        {
            ...
            if (game.Mode is RegionMapMode regionMapMode)
            {
                ...
                if (RegionMapMode.CanPanToPosition(game.Overworld.CurrentRegion, newPosition))
                {
                    ...
                    return new(ReactionResult.Silent, "Panned down.");
                }
                else
                {
