...
namespace NetAF.Tests.Interpretation
{
    ...
    public class FrameCommandInterpreter_Tests
    {
        ...
        public void GivenEmptyString_WhenInterpret_ThenReturnFalse()
        {
            ...
            var game = Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => overworld, () => new PlayableCharacter(string.Empty, string.Empty)), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
        ...
        {
            var interpreter = new FrameCommandInterpreter();
            var game = Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => null, () => new PlayableCharacter(string.Empty, string.Empty)), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
