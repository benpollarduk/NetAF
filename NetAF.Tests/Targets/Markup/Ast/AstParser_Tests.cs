...
namespace NetAF.Tests.Targets.Markup.Ast
{
    ...
    public class AstParser_Tests
    {
        ...
        [TestMethod]
        public void GivenStrikethroughText_WhenTryParse_ThenReturnTrueAndDocumentWithParagraphContainingStrikethroughTextInStyleSpanNode()
        {
            ...
            Assert.IsNotNull(paragraph);
            Assert.IsNotNull(styleSpan);
            Assert.IsTrue(styleSpan.Style.Strikethrough);
            Assert.IsNotNull(text);
            Assert.AreEqual("Test", text.Text);
        }
        ...
        public void GivenMonospaceText_WhenTryParse_ThenReturnTrueAndDocumentWithParagraphContainingMonospaceTextInStyleSpanNode()
        {
            ...
            Assert.IsNotNull(paragraph);
            Assert.IsNotNull(styleSpan);
            Assert.IsTrue(styleSpan.Style.Monospace);
            Assert.IsNotNull(text);
            Assert.AreEqual("Test", text.Text);
        }
