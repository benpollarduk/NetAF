...
namespace NetAF.Tests.Commands.Game
{
    ...
    public class Take_Tests
    {
        ...
        public void GivenNoCharacter_WhenInvoke_ThenError()
        {
            ...
            var game = NetAF.Logic.Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => overworld, () => null), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
