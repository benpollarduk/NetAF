...
namespace NetAF.Tests.Commands.Game
{
    ...
    public class UseOn_Tests
    {
        ...
        {
            var game = NetAF.Logic.Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => null, () => new PlayableCharacter("", "")), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
        ...
        public void GivenTargetIsNpc_WhenInvoke_ThenOK()
        {
            ...
            var game = NetAF.Logic.Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => null, () => player), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
        ...
        public void GivenTargetIsPlayer_WhenInvoke_ThenOK()
        {
            ...
            var overworld = new Overworld(string.Empty, string.Empty);
            overworld.AddRegion(region);
            var game = NetAF.Logic.Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => overworld, () => pc), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
        ...
        public void GivenTargetIsRoom_WhenInvoke_ThenOK()
        {
            ...
            overworld.AddRegion(region);
            var player = new PlayableCharacter(Identifier.Empty, Description.Empty);
            var game = NetAF.Logic.Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => overworld, () => player), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
