...
namespace NetAF.Tests.Commands.Persistence
{
    ...
    public class Save_Tests
    {
        ...
        public void GivenValidPath_WhenInvoke_ThenOK()
        {
            ...
            var game = NetAF.Logic.Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, AssetGenerator.Retained(overworldMaker.Make(), new PlayableCharacter(string.Empty, string.Empty)), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
