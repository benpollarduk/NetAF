...
{
    [TestClass]
    public class PanDown_Tests
    {
        [TestMethod]
        public void GivenNullGame_WhenInvoke_ThenError()
        {
            var command = new PanDown();
        ...
        [TestMethod]
        public void GivenFocusPositionOf000_WhenGetPanPosition_ThenReturn00Minus1()
        {
            var result = PanDown.GetPanPosition(new Point3D(0, 0, 0));
