...
{
    [TestClass]
    public class PanSouth_Tests
    {
        [TestMethod]
        public void GivenNullGame_WhenInvoke_ThenError()
        {
            var command = new PanSouth();
        ...
        [TestMethod]
        public void GivenFocusPositionOf000_WhenGetPanPosition_ThenReturn0Minus10()
        {
            var result = PanSouth.GetPanPosition(new Point3D(0, 0, 0));
