...
{
    [TestClass]
    public class PanNorth_Tests
    {
        [TestMethod]
        public void GivenNullGame_WhenInvoke_ThenError()
        {
            var command = new PanNorth();
        ...
        [TestMethod]
        public void GivenFocusPositionOf000_WhenGetPanPosition_ThenReturn010()
        {
            var result = PanNorth.GetPanPosition(new Point3D(0, 0, 0));
