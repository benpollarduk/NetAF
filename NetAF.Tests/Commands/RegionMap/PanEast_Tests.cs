...
{
    [TestClass]
    public class PanEast_Tests
    {
        [TestMethod]
        public void GivenNullGame_WhenInvoke_ThenError()
        {
            var command = new PanEast();
        ...
        [TestMethod]
        public void GivenFocusPositionOf000_WhenGetPanPosition_ThenReturn100()
        {
            var result = PanEast.GetPanPosition(new Point3D(0, 0, 0));
