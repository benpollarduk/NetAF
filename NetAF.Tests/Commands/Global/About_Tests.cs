...
namespace NetAF.Tests.Commands.Global
{
    ...
    public class About_Tests
    {
        ...
        public void GivenValidGame_WhenInvoke_ThenInternal()
        {
            ...
            var game = NetAF.Logic.Game.Create(new GameInfo(string.Empty, string.Empty, string.Empty), string.Empty, new GameAssetGenerators(() => overworld, () => new PlayableCharacter(string.Empty, string.Empty)), GameEndConditions.NoEnd, GameConfiguration.Default).Invoke();
            var command = new About();
